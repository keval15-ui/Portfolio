  ...
  const projects = [
    {
      ...
      title: "SAKSHAM",
      description:
        "An educational platform for underprivileged students with learning resources, mentorship, and scholarship opportunities.",
    ...
    },
    {
      ...
      description:
        "A feature-rich online shopping platform with product management, cart functionality, and payment integration.",
    ...
    },
    {
      ...
      description:
        "Electronic health records system for clinics to manage patient data, appointments, and medical histories.",
    ...
    },
    {
      ...
      description:
        "Interactive dashboard for monitoring and managing smart city services including traffic, energy, and waste management.",
    ...
    },
    {
      ...
      description:
        "Financial analysis platform with data visualization, budget tracking, and investment portfolio management.",
    ...
    },
    {
      ...
      description:
        "Crop monitoring and farm management system using IoT sensors to track soil health, water usage, and crop growth.",
    ...
    <section className="projects-section" id="projects">
      <div className="projects-container">
        ...
        <p className="projects-intro">
          Explore my portfolio of projects spanning various sectors and
          industries. Each project represents solutions to real-world
          challenges.
        </p>
        ...
        <div className="projects-filter">
          ...
          <button
            className={`filter-btn ${
              activeFilter === "full-stack" ? "active" : ""
            }`}
