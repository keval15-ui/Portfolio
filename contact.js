document.addEventListener('DOMContentLoaded', function() {
    // Animation system for contact page - similar to about page
    ...
    // Set session storage for smooth transition back to home page
    ...
    window.addEventListener('scroll', function() {
        ...
        // Apply subtle parallax to items with staggered effect
        document.querySelectorAll('.contact-method').forEach((item, index) => {
    ...
    // Add interactive effect on info card
    const infoCard = document.querySelector('.info-card');
    if (infoCard) {
        infoCard.addEventListener('mousemove', function(e) {
    ...
    if (contactForm) {
        // Add interaction effects on form elements
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                const feedback = createFeedbackModal('success');
    ...
    // Create custom cursor elements (same as about page)
    ...
    const interactiveElements = document.querySelectorAll('a, button, .social-link, .contact-method, .home-link');
    ...
    // Helper function to create feedback modal
    function createFeedbackModal(type) {
        ...
        if (type === 'success') {
            feedbackEl.innerHTML = `
                ...
                <h3 class="feedback-title">Message Sent!</h3>
                <p class="feedback-message">Thank you for reaching out. I'll get back to you soon.</p>
            ...
            feedbackEl.innerHTML = `
                ...
                <p class="feedback-message">Please try again or contact me directly via email.</p>
                <button class="feedback-close">Close</button>
            `;
        }
        ...
        setTimeout(() => {
            const closeBtn = feedbackEl.querySelector('.feedback-close');
            if (closeBtn) {
